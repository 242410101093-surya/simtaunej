        ...
        <div class="card mb-4">
            ...
            <div class="card-body text-center">
                ...
                <div class="alert {{ $mahasiswa->statusMahasiswa?->layak_sidang ? 'alert-success' : 'alert-warning' }}">
                    ...
                    <p class="mb-0">{{ $mahasiswa->statusMahasiswa?->getStatusText() ?? 'Bimbingan Sempro' }}</p>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="progress" style="height: 25px;">
                        <div class="progress-bar"
                             style="width: {{ $mahasiswa->statusMahasiswa?->getProgresPercentage() ?? 0 }}%; background: linear-gradient(135deg, var(--unej-red), var(--unej-green));"
                             role="progressbar">
                            {{ $mahasiswa->statusMahasiswa?->getProgresPercentage() ?? 0 }}%
                        </div>
                    </div>
                </div>
